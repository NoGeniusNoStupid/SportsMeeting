<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePwd.aspx.cs" Inherits="SportsMeeting.AdminPage.AdminPage.UpdatePwd" %>
    ...
    <div class="x-body layui-anim layui-anim-up">
       ...
       <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <asp:TextBox ID="OldPwd" runat="server" TextMode="Password" lay-verify="OldPwd" autocomplete="off" class="layui-input"></asp:TextBox>
