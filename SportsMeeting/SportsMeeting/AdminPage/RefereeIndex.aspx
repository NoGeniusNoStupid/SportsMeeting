<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RefereeIndex.aspx.cs" Inherits="SportsMeeting.AdminPage.RefereeIndex" %>
            ...
            <ul id="nav">
                <li>
                 ...
                 <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a _href="/AdminPage/AdminPage/UpdatePwd.aspx?type=1">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>密码修改</cite>
                            </a>
                        </li>
